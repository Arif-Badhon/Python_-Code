...
# advance to the next round, as long as the contestant earns a positive score..." 
...
# Input
# The first line of the input contains two integers n and k (1 ≤ k ≤ n ≤ 50) separated by a single 
# space.
