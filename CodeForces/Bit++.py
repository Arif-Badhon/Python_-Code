...
#A statement in language Bit++ is a sequence, consisting of exactly one operation and 
# one variable x. The statement is written without spaces, that is, it can only contain 
...
# The initial value of x is 0. Execute the programme and find its final value 
